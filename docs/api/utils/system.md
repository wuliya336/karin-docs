...
system模块提供了系统级工具函数，包括执行命令、时间处理、IP检测、多媒体处理等功能。

## 命名空间使用

system模块可以作为命名空间整体导入，也可以直接导入其中的函数：
...
ffmpeg模块提供了FFmpeg、FFprobe和FFplay命令的封装。
